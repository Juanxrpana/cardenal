...
class registro_clientes extends Conexion{
    ...
    private $id_clientes ;
	private $persona_id_persona; //recuerden que en php, las variables no tienen tipo predefinido
	private $usuario_id_usuario;
	private $organizacion_id_organizacion ;
	...
	function set_persona_id_persona($valor){
		$this->persona_id_persona = $valor;
	}

	function set_usuario_id_usuario($valor){
		$this->usuario_id_usuario = $valor;
	}

	function set_organizacion_id_organizacion ($valor){
        $this->organizacion_id_organizacion  = $valor;
    }

	function set_tipodecliente($valor){
		$this->tipodecliente = $valor;
	}
    ...
    function get_persona_id_persona(){
    ...
    function get_organizacion_id_organizacion (){
        return $this->organizacion_id_organizacion ;
    }
	
	function get_tipodecliente(){
